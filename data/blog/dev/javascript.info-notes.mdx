...
- [https://javascript.info/object-toprimitive#hints](https://javascript.info/object-toprimitive#hints)
...
- [https://javascript.info/primitives-methods#a-primitive-as-an-object](https://javascript.info/primitives-methods#a-primitive-as-an-object)
...
- [https://javascript.info/number#more-ways-to-write-a-number](https://javascript.info/number#more-ways-to-write-a-number)
...
- [https://javascript.info/number#tostring-base](https://javascript.info/number#tostring-base)
...
- [https://javascript.info/number#tests-isfinite-and-isnan](https://javascript.info/number#tests-isfinite-and-isnan)
...
- [https://javascript.info/array#get-last-elements-with-at](https://javascript.info/array#get-last-elements-with-at)
...
- [https://javascript.info/array#internals](https://javascript.info/array#internals)
...
- [https://javascript.info/array#performance](https://javascript.info/array#performance) 🤯
...
- [https://javascript.info/destructuring-assignment](https://javascript.info/destructuring-assignment) #til
...
- [https://javascript.info/map-set#iteration-over-set](https://javascript.info/map-set#iteration-over-set) #funny
...
- [https://javascript.info/iterable#symbol-iterator](https://javascript.info/iterable#symbol-iterator)
...
- [https://javascript.info/iterable#array-like](https://javascript.info/iterable#array-like)
    - *Iterables* are objects that implement the `Symbol.iterator` method.
    - *Array-likes* are objects that have indexes and `length`, so they look like arrays.
    
    These two feel like arrays but are not arrays! #psych
    
- [https://javascript.info/weakmap-weakset#summary](https://javascript.info/weakmap-weakset#summary)
...
- [https://javascript.info/recursion#the-execution-context-and-stack](https://javascript.info/recursion#the-execution-context-and-stack)
...
## [Rest Parameters & Spread Syntax](https://javascript.info/rest-parameters-spread)
...
- [https://javascript.info/rest-parameters-spread#the-arguments-variable](https://javascript.info/rest-parameters-spread#the-arguments-variable)
...
- An use-case
    ...
    **Context is present**
    ...
    - To prevent issues as [mentioned above](https://www.notion.so/JavaScript-a78c3c235d034f8c91364a37f676fce2), we can use bind which **fixes the context in time** to the function. So even if the `user` object is altered before the bound function runs, the bound function runs
...
# [Object Properties Config](https://javascript.info/object-properties)
