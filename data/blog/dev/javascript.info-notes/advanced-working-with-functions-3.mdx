...
- We can emulate the `setInterval` behaviour using nested `setTimeout`s. Frankly, that’s a more controllable way of running code regularly
    ...
    **setInterval timeline**
    ...
    <Image src="/static/images/blog/javascript.info-notes/advanced-working-with-functions/setinterval-timeline.png" width={5000} height={500} alt="Demarcations showing where the lexical environment for a function ends and the global lexical environment begins"/>
    ...
    **setTimeout timeline**
    ...
    <Image src="/static/images/blog/javascript.info-notes/advanced-working-with-functions/setinterval-using-settimeout-timeline.png" width={5000} height={500} alt="Demarcations showing where the lexical environment for a function ends and the global lexical environment begins"/>
